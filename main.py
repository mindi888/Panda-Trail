...
game_instruc2 = instruction_font.render('Use the up arrow to jump', False, "Black")
game_instruc3 = instruction_font.render('Use the down arrow to roll', False, "Black")
